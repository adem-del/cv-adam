...
echo "   git remote add origin https://github.com/DEIN-USERNAME/cv-adem.git"
...
echo "   2. „Import Git Repository“ > dein cv-adem Repo"
...
echo ""
echo "✅ Fertig! Deine Seite ist live unter: https://cv-adem.vercel.app"
echo ""
echo "🎯 Optional: https://cv-adem.vercel.app → dein-name.vercel.app"
