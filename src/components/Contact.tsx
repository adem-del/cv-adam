...
export default function Contact() {
  ...
  return (
    <Section id="contact" title="Kontakt" className="bg-slate-50 dark:bg-slate-900/50">
      <div className="max-w-xl space-y-6">
        ...
        <div className="space-y-4">
          <a
            ...
            className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:shadow-md transition-shadow"
          >
